...
export const contractorList: ContractorSummary[] = [
  {
    ...
    specialty: "Renovasi Rumah",
    projects: "Renovasi rumah",
    projectCount: 41,
    tier: "Gold",
    rating: 5,
    isReady: true,
  },
  {
    id: "aris-setiawan",
    name: "Aris Setiawan",
    image: "/images/mandor/mandor-aris%20setiawan.png",
    specialty: "Bangun Baru",
    projects: "Bangun baru",
    projectCount: 16,
    tier: "Silver",
    rating: 5,
    isReady: false,
  },
  {
    id: "ahmad-zaelani",
    name: "Ahmad Zaelani",
    image: "/images/mandor/mandor-ahmad%20zaelani.png",
    specialty: "Renovasi kantor/ruko",
    projects: "Renovasi kantor/ruko",
    projectCount: 32,
    tier: "Gold",
    rating: 5,
    isReady: false,
  },
  {
    id: "budiwarman",
    name: "Budiwarman",
    image: "/images/mandor/mandor-Budiawarman.png",
    specialty: "Bangun Baru",
    projects: "Bangun baru",
    projectCount: 3,
    tier: "Bronze",
  ...
  },
  {
    ...
    specialty: "Perbaikan Kecil",
    projects: "Perbaikan kecil",
    projectCount: 36,
    tier: "Gold",
    rating: 5,
    isReady: false,
  ...
  },
  {
    id: "nanang-sherman",
    name: "Nanang Sherman",
    image: "/images/mandor/mandor-nanang%20suherman.png",
    specialty: "Renovasi kantor/ruko",
    projects: "Renovasi kantor/ruko",
    projectCount: 13,
    tier: "Silver",
...
export const contractorById: Record<string, ContractorDetail> = {
  "rio-prasetya": {
    ...
    heroImage: "/images/mandor/mandor-rio%20prasetyaa.png",
    portfolio: [
      {
        id: "porto-1",
        title: "Bangun Rumah",
